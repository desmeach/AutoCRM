...
<table>
	<tbody>
		<tr>
			<td><?echo GetMessage("main_register_sms")?></td>
...
<div class="row justify-content-center">
    ...
    <table>
        <thead>
            <tr>
                <td colspan="2" class="text-center"><b><?=GetMessage("AUTH_REGISTER")?></b></td>
            </tr>
        </thead>
        <tbody>
    ...
    <?if($arResult["USER_PROPERTIES"]["SHOW"] == "Y"):?>
        <?foreach ($arResult["USER_PROPERTIES"]["DATA"] as $FIELD_NAME => $arUserField): ?>
            <?$arUserField['USER_TYPE']['USE_FIELD_COMPONENT'] = 0; ?>
                <tr>
                    <? if ($FIELD_NAME != 'UF_KEY'): ?><td><?=$arUserField["EDIT_FORM_LABEL"]?>:</td> <? endif; ?>
                    <td>
                    <?$APPLICATION->IncludeComponent(
    ...
    if ($arResult["USE_CAPTCHA"] == "Y")
    {
        ?>
            ...
            <tr>
                <td><?=GetMessage("REGISTER_CAPTCHA_PROMT")?>:</td>
