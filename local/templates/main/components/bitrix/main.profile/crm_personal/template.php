...
<div class="profile-block-<?= mb_strpos($arResult["opened"], "reg") === false ? "hidden" : "shown"?>" id="user_div_reg">
	...
	if ($arResult["arUser"]["PERSONAL_PHOTO"])
		$photoPath = CFile::GetPath($arResult["arUser"]["PERSONAL_PHOTO"]);
	else
		$photoPath = '/include/avatars/default.png';
	?>
	<img
		src="<?=$photoPath?>"
		border=0,
	...
	<div class="text-center mt-1">
		<input name="PERSONAL_PHOTO" class="typefile form-control form-control-sm m-auto"  style="width: 250px;" type="file" />
		<span class="bx-input-file-desc">
		<input type="checkbox" class="form-check-input" name="PERSONAL_PHOTO_del" value="Y" id="PERSONAL_PHOTO_del" />
	...
	<tr>
		...
		<td><input class="form-control" type="text" name="TITLE" value="<?=$arResult["arUser"]["TITLE"]?>" /></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><input class="form-control" type="text" name="LOGIN" maxlength="50" value="<?php echo $arResult["arUser"]["LOGIN"]?>" /></td>
	</tr>
	<tr>
    ...
    <tr>
        <td><?=GetMessage('MY_CAR_SERVICE')?></td>
        <td><input class="form-control" type="text" name="UF_CARSERVICE" maxlength="50" value="<?php echo $arResult["arUser"]["UF_CARSERVICE"]?>" autocomplete="off" /></td>
    </tr>
<?if($arResult["PHONE_REGISTRATION"]):?>
	<tr>
		<td><?echo GetMessage("main_profile_phone_number")?><?if($arResult["PHONE_REQUIRED"]):?><span class="starrequired">*</span><?endif?></td>
		<td><input class="form-control" type="text" name="PHONE_NUMBER" maxlength="50" value="<?php echo $arResult["arUser"]["PHONE_NUMBER"]?>" /></td>
	</tr>
<?endif?>
...
<?endif?>
	...
	<p><input class="btn btn-primary" type="submit" name="save" value="<?=(($arResult["ID"]>0) ? GetMessage("MAIN_SAVE") : GetMessage("MAIN_ADD"))?>">&nbsp;&nbsp;<input class="btn btn-primary" type="reset" value="<?=GetMessage('MAIN_RESET');?>"></p>
</form>
